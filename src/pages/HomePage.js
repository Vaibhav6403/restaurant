...
import AOS from "aos";
import contactnew from "../assets/contactnew.jpg"
...
const HomePage = () => {
  ...
  const imagearray = [
    {
      image:
        "https://erestaurantconsulting.ca/wp-content/uploads/2022/08/menu-development.jpg",
      text: "Koko - The Main",
    ...
    {
      image:
        "https://media.istockphoto.com/id/1463050489/photo/online-application-form-for-modish-registration.jpg?s=1024x1024&w=is&k=20&c=l4VsFtkR_VNyB2Z2fwYs3p962J5HNIhz8b-cI4sYg54=",
      text: "Koko - The Main",
      desc: "Coming Soon Toronto, ON",
    ...
    <>
      ...
      <div className="w-full h-full flex flex-col items-center relative">
        <div className=" w-full h-[800px] relative">
          ...
          <div className="absolute top-[330px] left-[400px] w-[550px] flex flex-col items-center text-center">
            <div data-aos="slide-left">
              <h1 className="text-5xl text-sky-500 ">
                Restaurant Solutions For Business Leaders
              </h1>
            </div>
            <div className="bg-white w-[100px] h-[2px] mt-8  left-60"></div>
        ...
        <div className=" flex items-center justify-center flex-col w-[550px] mt-1">
          ...
          <div className="bg-sky-500   w-[270px] h-[2px] mt-3"></div>
          <div className="flex">
            <TypeAnimation
              sequence={["Experience", 2000, "Passion", 2000]}
              wrapper="span"
              speed={50}
              cursor={false}
          ...
          <p className="mt-5 font-serif ml-7 mb-4">
            Making money in the restaurant business requires a deep
            understanding of restaurant operations, customer expectations and
            the industry as a whole. At ERC, we make it our mission to increase
            restaurant profit margins, drawing on years of expertise and a
            dedication to delivering for our clients.
          </p>
        ...
        <div className="relative mt-12 w-full h-[500px]">
          ...
          >
            ...
            <div className="flex w-[500px]">
              <div className="absolute top-40 left-40 text-white p-4 text-4xl w-[600px] leading-2 z-20 font-semibold leading-2 animate">
                ERC OFFERS A{" "}
                <span className="text-sky-500 text-4xl ">FREE 30-MINUTE</span>{" "}
                PHONE CONSULTATION TO ANY FOOD SERVICE PROFESSIONAL
              </div>
              <div></div>
              <div className="absolute top-[180px] right-20 flex flex-col gap-3 mr-5">
        ...
        <div className="flex flex-col items-center justify-center mt-12 w-[800px]">
          ...
          <p className="text-2xl text-sky-500 text-center mt-3">
            Did You Know 82% Of Guests Order Food Online Directly From A
            Restaurant Website?
          </p>
          <p className="text-lg mt-5">
            Make your Restaurant an Online Digital, Delivery & Takeout
            Powerhouse in 3 Steps
          </p>
          <div className="flex mt-6 gap-8 justify-evenly w-[700px] relative">
            <div className="flex flex-col gap-4">
              <button className="text-sky-500 text-2xl rounded-lg border-2 border-sky-500 p-4 ">
                <p data-aos="fade-right" data-aos-anchor="center-top" data-aos-offset="200px">Schedule a Call</p>
              </button>
              <button className="text-sky-500 text-2xl rounded-lg border-2 border-sky-500 p-4">
                <p data-aos="fade-right" data-aos-anchor="center-top">Get Your Plan</p>
              </button>
              <button className="text-sky-500 text-2xl rounded-lg border-2 border-sky-500 p-4">
                <p data-aos="fade-right" data-aos-anchor="center-top">Win Online</p>
              </button>
            </div>
            <div className="flex flex-col w-[300px] gap-3">
              ...
              <p className="text-lg">
                Mobile friendly, engaging online store directly connected to
        ...
        <div className="">
          <h1 className="text-5xl mt-12">Concepts in Progress</h1>
        ...
        <div className="text-center bg-neutral-100 w-full mx-auto mt-12">
          <h1 className="text-4xl font-bold mt-6 sans-serif">
        ...
        <div className=" w-full flex flex-col items-center pt-10 pb-10 opacity-95 hero"  style={{
              backgroundImage: `url(${contactnew})`,
              backgroundSize: "cover",
              backgroundRepeat: "no-repeat",
              width: "100%",
              minHeight: "auto",
          ...
          <div className="flex mt-8 space-x-60 justify-evenly ">
            <div className="flex flex-col mt-8 space-y-2">
              ...
              <input type="text" className="px-6"></input>
              ...
              <input type="text"></input>
              <label className="text-white">Your message (optional)</label>
            ...
            <div className="text-xl text-white w-[400px] mt-8 opactiy-100" >
              Making money in the restaurant business requires a deep
              understanding of restaurant operations, customer expectations and
